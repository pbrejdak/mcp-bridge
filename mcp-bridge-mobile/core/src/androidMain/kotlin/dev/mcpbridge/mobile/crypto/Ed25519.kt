...
// Identical body to the JVM actual. We could lift this to a shared
// `jvmAndroidMain` intermediate source set; for now, two files keep
// the source-set wiring trivial and the divergence cost is one
// keystroke (any change made here must also land in jvmMain). The
// Android KeyStore wrapper that hardware-binds Origin keys is a
// strictly additive layer on top of this byte-array surface and
